...
public class popularAdapter extends RecyclerView.Adapter<popularAdapter.MyViewHolder> {
    ...
    public popularAdapter(PopularFragment popularFragment, ArrayList<Result> mlist, Context context) {
        this.mlist = mlist;
    ...
    @Override
    public popularAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
